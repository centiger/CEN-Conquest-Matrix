const HUBS = [
  ...
  },
  {
    ...
    connections:['라합의 흐름: 라합 → 보아스 → 다윗 → 예수 그리스도','붉은 줄의 흐름: 유월절 피 → 라합의 붉은 줄 → 십자가','나팔의 흐름: 여리고 나팔 → 절기의 나팔 → 마지막 나팔','순종의 흐름: 요단강 도하 → 여리고 행진 → 첫 승리','길갈 ↔ 여리고 ↔ 아이성: 전진기지에서 첫 승리, 그리고 다음 전투로 이어짐'],
    integrated:['구속의 흐름: 이스라엘의 구원 → 라합의 구원 → 그리스도의 족보','언약의 흐름: 약속의 땅 → 순종의 행진 → 첫 성의 함락','하나님 나라의 흐름: 가나안 진입 → 여리고 함락 → 정복 확대','심판과 구원의 흐름: 여리고 심판 → 라합 구원 → 십자가의 구원'],
  ...
  },
  {
    ...
    connections:['아브라함 언약의 흐름: 약속의 땅 → 가나안 정복 → 기업 분배','순종의 흐름: 요단강 도하 → 여리고 순종 → 아이성의 실패와 회복','하나님 나라의 흐름: 정복 → 기업 → 왕국','거룩의 흐름: 아간의 범죄 → 회개와 정결 → 회복된 승리','기브온 전투 ↔ 태양이 멈춘 기적: 하나님이 전쟁의 주권자이심'],
    integrated:['구속의 흐름: 출애굽 → 광야 → 정복 → 기업','언약의 흐름: 아브라함 언약 → 약속의 땅 → 세겜 언약 갱신','하나님 나라의 흐름: 땅의 회복 → 백성의 정착 → 왕국의 기초','심판과 구원의 흐름: 가나안 심판 → 라합·기브온의 생존 → 언약 백성의 형성'],
  ...
  },
  {
    ...
    connections:['아브라함 언약의 흐름: 아브라함 → 약속의 땅 → 정복 → 기업 분배','열두 지파의 흐름: 야곱의 열두 아들 → 열두 지파 → 지파별 기업','성막의 흐름: 광야 성막 → 실로 성막 → 예루살렘 성전','레위의 흐름: 레위 지파 → 제사장 직분 → 성전 봉사 → 그리스도','도피성의 흐름: 도피성 → 보호와 공의 → 그리스도 안의 피난처'],
    integrated:['구속의 흐름: 출애굽 → 정복 → 기업 → 정착','언약의 흐름: 아브라함 언약 → 땅의 약속 → 기업 분배 → 세겜 언약','하나님 나라의 흐름: 땅 → 백성 → 예배 중심 공동체','예배의 흐름: 성막 → 실로 → 성전 → 참 성전이신 그리스도','사사시대 연결: 지파 정착 → 지역별 위기 → 사사들의 등장'],
  ...
  },
  {
    ...
    connections:['언약의 흐름: 아브라함 언약 → 시내산 언약 → 세겜 언약 → 새 언약','세겜의 흐름: 아브라함의 약속 → 야곱의 제단 → 에발산·그리심산 → 여호수아의 언약 갱신','선택의 흐름: 에덴의 선택 → 세겜의 선택 → 갈멜산의 선택 → 복음 앞의 선택','증거의 흐름: 요단강 열두 돌 → 세겜의 증거돌 → 말씀과 성찬의 기억','정복시대 흐름: 입성 → 승리 → 정복 → 유업 → 헌신'],
